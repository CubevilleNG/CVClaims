...
public class ClaimCommand extends Command
{
    ...
    public CommandResponse execute(Player player, Set<String> flags, Map<String, Object> parameters, List<Object> baseParameters)
        ...
        if(selection.getWidth() > 50 || selection.getLength() > 50) throw new CommandExecutionException("Claimed regions can only be up to 50x50 blocks. Enter \"//size\" to check the size of your current selection (first and third values under \"Size:\", the middle number is the height).");
